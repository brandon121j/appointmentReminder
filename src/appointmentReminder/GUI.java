...
public class GUI implements ActionListener {
	...
	public static void main(String[] args) {
		...
		String[] times = { "12:00 am", "1:00 am", "2:00 am", "3:00 am", "4:00 am", "5:00 am", "6:00 am", "7:00 am",
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (date != null) {
			if (patient.length() != 0) {
				String message1 = ("Good morning, " + patient + " this is " + therapist
						+ " from Second Chance Behavioral Health. This is a reminder for our appointment scheduled for "
				...
				String message2 = ("Good morning, this is " + therapist
						+ " from Second Chance Behavioral Health. This is a reminder for our appointment scheduled for "
						+ dateFormat.format(date) + " at " + time + ". To join the session, click the link below. "
						+ "\r\n" + hyperlink + "\r\n" + "\r\n"
						+ "Please reply yes to this message to confirm the appointment or no to reschedule.");
			...
			JOptionPane.showMessageDialog(frame, "Appointment Date can't be empty!", "Error", JOptionPane.ERROR_MESSAGE);
		}
	}
}
